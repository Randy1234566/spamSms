import requests as reek,json,os,time,pyfiglet
req=reek.Session()
...
def cok():
	while True:
		try:
			a=input("[+] Nomer Korban 08×××\t: ").replace("-","")
			asu=a[0:2]
